        ...
        <div class="row flex-md-row flex-column-reverse">
            <div class="col-lg-6 align-self-center">
                <div class="banner-content-wrapper">
                    <h5>WELCOME TO</h5>
                    <h1>AVION <br> STAMPS</h1>
                    <ul class="mb-5">
                        <li>The largest stock in Europe</li>
                        <li>Family business established in 1948</li>
                            ...
                            <div class="row">
                                <div class="col-6 col-lg-2">
                                    <div class="alphabets-wrapper">
                                        <ul>
                                            <li>Stamps on Advertising</li>
                                            <li>Stamps on Afghan</li>
                                            <li>Stamps on Agriculture</li>
                                            <li>Stamps on Aids</li>
                                            <li>Stamps on Airports</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-2">
                                    <div class="alphabets-wrapper">
                                        <ul>
                                            <li>Stamps on Antiques</li>
                                            <li>Stamps on Apes</li>
                                            <li>Stamps on Apollo</li>
                                            <li>Stamps on Archaeology</li>
                                            <li>Stamps on Archery</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-2">
                                    <div class="alphabets-wrapper">
                                        <ul>
                                            <li>Stamps on American Football</li>
                                            <li>Stamps on Americana</li>
                                            <li>Stamps on Ancient Greece</li>
                                            <li>Stamps on Andrew</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-2">
                                    <div class="alphabets-wrapper">
                                        <ul>
                                            <li>Stamps on Artefacts</li>
                                            <li>Stamps on Arts</li>
                                            <li>Stamps on Astrology</li>
                                            <li>Stamps on Astronomy</li>
                                            <li>Stamps on Athletics</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-2">
