            ...
            <div class="col-lg-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">About Avion</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section class="about">
    <div class="container">
        ...
        <div class="about-avion" style="margin-top: 20px;">
            <h4>ROGER WEST</h4>
            <p>Roger is a well-known philatelist and an acknowledged expert in the stamps of St Helena. In 1994 he edited the handbook 'Madame
                Joseph Forged Postmarks', which has been widely acclaimed as one of the most important philatelic reference works. Roger
                has a number of displays that prove popular when shown to Societies all over the United Kingdom, namely St Helena Forgeries, Tete-Beche,
                Dominica, Specimen Stamps and his highly acclaimed 'An Evening Wasted'. Outside of philately, Roger enjoys good music (mainly Jazz, Classical,
                Country and Easy Listening) and has taken up playing the keyboard in recent years. His other passion is cooking - Chinese cuisine being his forte.</p>
            <h4>SUE WEST</h4>
